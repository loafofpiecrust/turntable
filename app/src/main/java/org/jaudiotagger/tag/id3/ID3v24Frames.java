...
public class ID3v24Frames extends ID3Frames
{
    ...
    private ID3v24Frames()
    {
        ...
        idToValue.put(FRAME_ID_ORIG_TITLE, "Text: Original album/Movie/Show name");
        ...
        idToValue.put(FRAME_ID_TITLE, "Text: name");
        idToValue.put(FRAME_ID_TITLE_REFINEMENT, "Text: Subtitle/Description refinement");
        idToValue.put(FRAME_ID_TITLE_SORT_ORDER, "Text: name sort order");
