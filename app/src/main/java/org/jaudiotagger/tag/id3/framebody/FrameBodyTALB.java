...
/**
 * Album/Movie/Show name Text information frame.
 * <p>The 'Album/Movie/Show name' frame is intended for the name of the recording(/source of sound) which the audio in the file is taken from.
 *
