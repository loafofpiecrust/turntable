...
/**
 * Original album/movie/show name Text information frame.
 * <p>The 'Original album/movie/show name' frame is intended for the name of the original recording (or source of sound), if for example the music
