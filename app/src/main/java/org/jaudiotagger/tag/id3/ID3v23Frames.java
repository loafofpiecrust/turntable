...
public class ID3v23Frames extends ID3Frames
{
    ...
    private ID3v23Frames()
    {
        ...
        idToValue.put(FRAME_ID_V3_ORIG_TITLE, "Text: Original album/Movie/Show name");
        ...
        idToValue.put(FRAME_ID_V3_TITLE_SORT_ORDER_ITUNES, "Text: name sort order");
        ...
        idToValue.put(FRAME_ID_V3_TITLE_SORT_ORDER_MUSICBRAINZ, "Text: name sort order");
