...
public class ID3v22Frames extends ID3Frames
{
    ...
    private ID3v22Frames()
    {
        ...
        idToValue.put(FRAME_ID_V2_ALBUM, "Text: Album/Movie/Show name");
        ...
        idToValue.put(FRAME_ID_V2_ORIG_TITLE, "Text: Original album/Movie/Show name");
        ...
        idToValue.put(FRAME_ID_V2_TITLE_SORT_ORDER_ITUNES, "Text: name sort order");
