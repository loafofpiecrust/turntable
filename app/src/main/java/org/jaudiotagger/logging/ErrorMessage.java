...
public enum ErrorMessage
{
    ...
    MP4_NO_GENREID_FOR_GENRE("No genre uuid could be found for this genre atom with data length {0}"),
    ...
    WMA_INVALID_FIELD_NAME ("The field uuid {0} is not allowed for {1}"),
