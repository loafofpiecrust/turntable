...
public class Mp4AtomTree
{
    ...
    public Mp4AtomTree(FileChannel input, boolean closeOnExit) throws IOException, CannotReadException
    {
        buildTree(input, closeOnExit);
    }
    ...
    public DefaultTreeModel buildTree(FileChannel fc, boolean closeExit) throws IOException, CannotReadException
    {
//        FileChannel fc = null;
        try
        {
