...
public enum Mp4AtomIdentifier
{
    ...
    ALBM("albm", "Album name and track number (user-data)"),
    AUTH("auth", "Media author uuid (user-data)"),
    ...
    PERF("perf", "Media performer uuid (user-data)"),
    ...
    TITL("titl", "Media name (user-data)"),
