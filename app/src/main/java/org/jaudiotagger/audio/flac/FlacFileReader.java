...
public class FlacFileReader extends AudioFileReader
{
    ...
    @Override protected GenericAudioHeader getEncodingInfo(FileChannel raf) throws CannotReadException, IOException
    {
        return ir.read(raf);
    }

    @Override protected Tag getTag(FileChannel raf) throws CannotReadException, IOException
    {
        return tr.read(raf);
    }
}
