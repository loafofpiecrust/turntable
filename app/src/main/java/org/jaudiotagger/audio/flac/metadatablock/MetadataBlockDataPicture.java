...
public class MetadataBlockDataPicture implements MetadataBlockData, TagField
{
    ...
    {
        this(header, raf.getChannel());
    }

    public MetadataBlockDataPicture(MetadataBlockHeader header, FileChannel raf) throws IOException, InvalidFrameException
    {
     ...
     * one is for sure the name field. A web link may not be of common use for
