...
internal class ItagItem(val id: Int, val format: String, val resolution: String) {
    ...
    companion object {
        ...
        private val ITAG_MAP = mapOf(
            ...
            // Audio only streams
            140 to ItagItem(140, VideoStream.FORMAT_MPEG_4, VideoStream.AUDIO_ONLY), // m4a, 128kbs
            141 to ItagItem(141, VideoStream.FORMAT_MPEG_4, VideoStream.AUDIO_ONLY), // m4a, 256kbs
            171 to ItagItem(171, VideoStream.FORMAT_WEBM, VideoStream.AUDIO_ONLY), // webm, 128kbs
            251 to ItagItem(251, VideoStream.FORMAT_WEBM, VideoStream.AUDIO_ONLY) // webm, 160kbs
        )
