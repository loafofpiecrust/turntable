...
//
//    protected open var currentPosition = INVALID_POSITION
//        @IntRange(from = -1) get
//        set(position) {
//            field = findNextAllowedPosition(clamp(0, position, itemCount - 1))
//        }
//
//    /**
//     * Returns the current playlistId for this playlist.
//     *
//     * @return The playlist id [default: [.INVALID_ID]]
//     */
//    /**
//     * Sets the ID associated with the current playlist
//     *
//     * @param id The id for the playlist, or [.INVALID_ID]
//     */
//    var id = INVALID_ID
//        @IntRange(from = INVALID_ID) get
//        set(@IntRange(from = INVALID_ID) value) { field = value }
//
//    @SupportedMediaType
...
//
//    protected val playPausePendingIntent = createPendingIntent(RemoteActions.ACTION_PLAY_PAUSE)
//    protected val nextPendingIntent = createPendingIntent(RemoteActions.ACTION_NEXT)
//    protected val previousPendingIntent = createPendingIntent(RemoteActions.ACTION_PREVIOUS)
//    protected val repeatPendingIntent = createPendingIntent(RemoteActions.ACTION_REPEAT)
//    protected val shufflePendingIntent: PendingIntent = createPendingIntent(RemoteActions.ACTION_SHUFFLE)
//    protected val stopPendingIntent: PendingIntent = createPendingIntent(RemoteActions.ACTION_STOP)
//
//    protected val seekEndedIntent: Intent = Intent(application, mediaServiceClass).apply { action = RemoteActions.ACTION_SEEK_ENDED }
//    protected val allowedTypeChangedIntent: Intent = Intent(application, mediaServiceClass).apply { action = RemoteActions.ACTION_ALLOWED_TYPE_CHANGED }
//    protected val seekStartedPendingIntent = createPendingIntent(RemoteActions.ACTION_SEEK_STARTED)
//
//    /**
...
//        get() = service?.getCurrentPlaybackState() ?: PlaylistServiceCore.PlaybackState.STOPPED
//
//    /**
...
//        get() = service?.getCurrentMediaProgress()
//
//    /**
...
//        get() = service?.getCurrentItemChange()
//
//    /**
...
//        get() = if (currentPosition != INVALID_POSITION && currentPosition < itemCount) {
...
//            application.startService(allowedTypeChangedIntent)
//        }
//    }
//
//    /**
...
//     */
////    open fun setCurrentPosition(@IntRange(from = 0) position: Int) {
...
//        val position = getPositionForItem(itemId)
...
//
//
//        return if (item == null || currentItem == null) {
//            false
//        } else item.id == currentItem.id && item.playlistId == id
//
//    }
//
//    /**
...
//        }
//
//        while (position in 0 until itemCount && !isAllowedType(getItem(position))) {
//            position++
//        }
//
//        return if (position < itemCount) position else itemCount
//    }
//
//    /**
...
//        }
//
//        return if (position >= 0) position else itemCount
//    }
//
//    /**
...
//     */
//    protected fun isAllowedType(item: I?): Boolean = run {
//        (item != null && item.mediaType != 0) && (allowedTypeFlag and item.mediaType) != 0
//    }
//
//    /**
...
//     */
//    protected fun createPendingIntent(action: String): PendingIntent {
//        val intent = Intent(application, mediaServiceClass)
